            ...
            try {
               while (keepAlive) {
                  ...
                  try {
                     ...
                     // A SocketException is thrown when the stop method calls
                     // 'close' on the
                     // serverSocket object. This means we should break out of
                     // the connection
                     // accept loop.
                     keepAlive = false;
                  }
